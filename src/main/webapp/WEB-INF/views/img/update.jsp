					...
					<form action="./update" method="post" enctype="multipart/form-data"
						...
						<div class="col-xs-12">
							<div class="blog-warp-1 wow fadeInLeft" data-wow-delay="0.9s">
								...
								원본파일명 : ${dto.nail_img }
									...
									<h4>
										썸네일 파일을 다시 업로드해주세요. <input type='file' name='filenameMF'/>
									</h4>
									<h4>
										제목 :<input type="text" name="title" value = "${dto.title }"/>
									</h4>
									<h4>
										소제목 : <input type="text" name="subtitle" value = "${dto.subtitle }" />
									</h4>
									<h4>

										<select name="classes" id="classes"
											onchange="doChange(this, 'types')">
											<option value="">--분류을  다시 선택하세요--</option>
						...
						<div class="col-xs-12">
							...
							<div class="slider_btn text-center"
								...
								<a href="javascript:history.back()" class="btn-primary">취소</a>
							</div>
