...
<table border="0" cellspacing="0" cellpadding="2"  align="center"> 
    <tr>  
        <td align="center"> 
            <textarea cols="130" rows="20">Cummunity 서비스약관 (2016. 7. 18 부터 유효) 
   
제1조(목적 등) 
 
  
① Cummunity (www.ohwang.co.kr) 서비스 약관(이하 "본 약관"이라 합니다)은 이용자가 ㈜ 왕은실캘리그라피(이하 "Cummunity"이라 합니다)에서 제공하는 인터넷 관련 서비스(이하 "서비스"라 합니다)를 이용함에 있 어 이용자와 "Cummunity"의 권리·의무 및 책임사항을 규정함을 목적으로 합니다. 
...
본 약관은 2016. 7. 18. 부터 적용하고, 2014. 10. 11.부터 적용되던 종전의 약관은 본 약관으로 대체합니다.  
            </textarea> 
        </td> 
    </tr> 
</table> 
