...
<!-- 			</div> -->
			...
			<br><br>
				  ...
				  <ul class="projects-titles2" id="b">                	
                        <li style="font-size: 18px; font-family: '휴먼편지체';" onclick="exhibitList('')" >전체</li>
                        <li style="font-size: 18px; font-family: '휴먼편지체';" onclick="exhibitList('work')" >작품</li>
                        <li style="font-size: 18px; font-family: '휴먼편지체';" onclick="exhibitList('exhibiting')">진행전시</li>
                        <li style="font-size: 18px; font-family: '휴먼편지체';" onclick="exhibitList('exhibited')">이전전시</li>
